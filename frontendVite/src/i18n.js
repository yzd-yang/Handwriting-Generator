...
const messages = {
  en: {
    message: {
      ...
      strikethrough_length_sigma: 'Standard deviation of the strikethrough length',
      strikethrough_width_sigma: 'Standard deviation of the strikethrough width',
      strikethrough_angle_sigma: 'Standard deviation of the strikethrough angle',
      ...
      paragraphLayout: 'Paragraph Alignment',
      alignDefault: 'Default (Left)',
      alignCenter: 'Center',
      alignRight: 'Right',
      firstLineIndent: 'First Line Indent (chars)',
      paragraphSpacing: 'Paragraph Spacing (lines)',
      email: 'Email',
      feedback: 'Feedback',
      introduce: 'Introduce',
      freeprompt: 'This website is free. If you are charged, please refund.',
      paperTemplateBlank: 'Blank',
      paperTemplateLines: 'Lines',
      paperTemplateGrid: 'Grid',
      paperTemplateDots: 'Dots',
      paperColorWhite: 'White',
      paperColorWarmYellow: 'Eye-care Yellow',
      paperColorLightGreen: 'Light Green',
      paperColorLightBlue: 'Light Blue',
      paperColorPink: 'Light Pink',
      paperColorDarkGray: 'Dark Gray',
      paperColorNavy: 'Navy Night',
      paperSizeA4: 'A4',
      paperSizeA5: 'A5',
      paperSizeB5: 'B5',
  ...
  cn: {
    message: {
      ...
      paragraphLayout: '段落对齐',
      alignDefault: '默认（左对齐）',
      alignCenter: '居中',
      alignRight: '右对齐',
      firstLineIndent: '首行缩进（字）',
      paragraphSpacing: '段间距（行）',
      email: '邮箱',
      feedback: '反馈',
      introduce: '介绍',
      freeprompt: '本网站是免费网站，如果你是付费访问的请退款',
      paperTemplateBlank: '空白',
      paperTemplateLines: '单线',
      paperTemplateGrid: '方格',
      paperTemplateDots: '点阵',
      paperColorWhite: '米白',
      paperColorWarmYellow: '护眼黄',
      paperColorLightGreen: '淡绿',
      paperColorLightBlue: '淡蓝',
      paperColorPink: '淡粉',
      paperColorDarkGray: '深灰',
      paperColorNavy: '深蓝夜',
      paperSizeA4: 'A4',
      paperSizeA5: 'A5',
      paperSizeB5: 'B5',
